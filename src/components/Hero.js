            ...
            <div id="intro" className="view">
                <div className="embed-responsive video-background-container">
                    <video id="video" autoPlay muted loop playsInline>
                        <source src="https://github.com/Hiverlab/reality-cast-landing-page/blob/master/public/images/Microsoft%20HoloLens%202%20Trailer.mp4?raw=true" type="video/mp4"/>
                    </video>
